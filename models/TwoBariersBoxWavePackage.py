...
config_file_name = "./configs/TwoBariersBoxWavePackage.json"
if args.config != None:
...
def main():
    ...
    try:
        ...
        f_mp4 = r"../video/two_bariers_box_wave_package" + date + r"_.mp4" 
        f_gif = r"../video/two_bariers_box_wave_package" + date + r"_.gif"
        ...
        log_file.write('TwoBariersBoxWavePackage.py exec time:\n')

...
- [X] Добавить функции transmission propability для всех случаев
...
- [X] Поменять расположение сравнительных графиков, чтобы они находились не рядом, а друг под другом
- [X] Исследовать transmission propability в обоих случаях. Есть ощущение, что то-то там работает не так, как надо
- [X] На сравнительных моделях вывод информации происходит только на одном графике. Исправить.
- [X] Пересмотреть сравнительную модель волнового пакета. Она вообще работает не так как надо. При больших значениях sigma волновой пакет наинает колбасить. Поэтому не рекомендуется ставить в качестве sigma слишком большие значения.
- [ ] Поправить расположение информации на графиках
- [X] Поменять размер фигуры так, чтобы это смотрелось прилично
- [X] При выводе графиков сравнения подписи осей и названия графиков выводятся только для одного графика. Исправить.

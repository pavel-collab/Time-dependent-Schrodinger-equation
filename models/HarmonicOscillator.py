...
def animate(i):
    ...
    if args.info != False:
        ...
        ax.text(
            x_start+8, 0.9, r'$\langle x \rangle =$ %0.2lf, $\langle p \rangle =$ %0.2lf, $\sigma = $ %0.2lf' 
...
def main():
    ...
    try:
        ...
        f_mp4 = r"../video/harmonic_oscillator_" + date + r"_.mp4"
        f_gif = r"../video/harmonic_oscillator_" + date + r"_.gif"  

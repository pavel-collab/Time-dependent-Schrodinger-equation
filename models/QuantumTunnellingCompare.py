...
def animate(i):
    ...
    if args.info != False:
        ...
        ax1.text(
            x_start+30, 0.1, r'$T = %0.2lf, \langle x \rangle =$ %0.2lf, $\langle p \rangle =$ %0.2lf, $\sigma = $ %0.2lf' 
...
def main():
    ...
    try:
        ...
        f_mp4 = r"../video/quantum_tunnelling_compare_" + date + r"_.mp4" 
        f_gif = r"../video/quantum_tunnelling_compare_" + date + r"_.gif" 
        writervideo = animation.FFMpegWriter(fps=fps) 
        
        # We can save it as a video .mp4
        ani.save(f_mp4, writer=writervideo)
        # Or we can save it as a gif .gif
        # ani.save(f_mp4, writer='pillow', dpi=500)
